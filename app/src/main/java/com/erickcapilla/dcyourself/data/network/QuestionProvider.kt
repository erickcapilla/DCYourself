...
class QuestionProvider {
    companion object {
        val questionsListM = listOf(
            DataQuestions("¿Actualmente está embarazada?"),
            DataQuestions("¿A notado que tiene un aumento de sed considerable?"),
            DataQuestions("¿Tiene micción frecuente (orinar más de los usual)?"),
            DataQuestions("¿Ultimamente tiene fatiga?"),
            DataQuestions("¿Tiene hambre excesiva?"),
            DataQuestions("¿Tiene sudoración?"),
            DataQuestions("¿Tiene nauseas o vomito?"),
